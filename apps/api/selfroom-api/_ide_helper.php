 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\ApiResponseServiceProvider::boot()
         * @param mixed $data
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::success($data, $statusCode);
        }
                    /**
         * 
         *
         * @see \App\Providers\ApiResponseServiceProvider::boot()
         * @param \Throwable $e
         * @param \App\Enums\ApplicationCode $errorCode
         * @param mixed $headers
         * @param array $errors
         * @static 
         */ 
        public static function error($e, $errorCode, $headers = [], $errors = [])
        {
                        return \Illuminate\Routing\ResponseFactory::error($e, $errorCode, $headers, $errors);
        }
