...
return [
    ...
    */
    ...
    'password' => [
      'letters' => ':attributeには少なくとも1文字が含まれていなければなりません。',
      'mixed' => ':attributeには、少なくとも大文字と小文字を1つずつ入れなければなりません。',
      'numbers' => ':attributeには少なくとも1つの数字が含まれていなければなりません。',
      'symbols' => ':attributeには、少なくとも1つの記号が含まれていなければなりません。',
      'uncompromised' => '指定された:attributeはデータ漏えいの一部として検出されました。別の:attributeに変更してください。',
    ],
    ...
    'single-char' => ':attributeは半角文字である必要があります。',
